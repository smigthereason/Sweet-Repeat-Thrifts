    ...
    return (
      <div className="w-screen">
        <section
          ...
          style={{
            backgroundImage: `url('src/assets/About2.jpeg')`,
          ...
          <div
            ...
            <h2
              className="text-6xl  mx-auto px-6 py-8"
              >
              About
            </h2>
          </div>
        ...
        <section className="bg-amber-50 w-screen text-black py-20 text-center justify-center">
